...
SECRET_KEY = 'django-insecure-uyo$*ath@i_a)90+h4_d-^g6pxgga1yiz_shp7vzo3x$&h^g-u'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'aws_project/templates')
            ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': "projectdb",
        'USER': "admin",
        'PASSWORD': "iamsimran123",
        'HOST': "django-rds.cheisayrmfoq.us-west-2.rds.amazonaws.com",
        'PORT': 3306,
        'OPTIONS': {
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'aws_project/static')
]
